  ...
  return (
    <ListGroup as="ol"  className="rounded overflow-hidden">
      <Form.Group className="mb-3 " controlId="formBasicEmail">
        ...
        <Form.Control className="" type="email" placeholder="Поиск..." />
      ...
      {products.map((user,index) => (
        <ListGroup.Item
          key={user.id}
          as="li"
          className={`d-flex ${index % 2 === 1 ? "bg-light" : "bg-dark-subtle "} ps-2`}
          
        >
          <div className='d-flex flex-row w-100 '>
            <div>
                <small className={`m-0 p-0 py-1 px-2 rounded mt-0 ${index % 2 === 1 ? "bg-dark-subtle" : "bg-light"}`}>{user.id}</small>
            </div>
            <div className='d-flex flex-column'>
            <h6 className='ms-2 m-0 p-0'>{user.name}</h6>              
              
            <div>
            <small className='ms-0 m-0 p-0 bg-success-subtlex ms-2 rounded mt-1'>{user.barCode}</small>
            <small className='ms-0 m-0 p-0 bg-warning-subtlex ms-2  rounded mt-1'>{user.code}</small>
            
            </div>
            </div>

            <div className='d-flex flex-column ms-auto'>
            <small className='ms-0 m-0 p-0 bg-primary-subtle px-2 rounded mt-1'>{user.bulkPrice.toLocaleString("uz")} UZS</small>            
              
            <small className='ms-0 m-0 p-0 bg-success-subtle px-2 rounded mt-1'>{user.bulkPrice.toLocaleString("uz")} UZS</small>
        ...
        >
          <div className='d-flex flex-row w-100 '>
            ...
            <div className='d-flex align-items-center h-0 ms-auto me-2'>
                ...
                <small className="ms-2 p-0">{1}</small>
                <Button
                onClick={()=>{
            ...
            <div className='d-flex flex-column'>
            <small className='ms-0 m-0 p-0 bg-primary-subtle px-2 rounded mt-1'>{user.bulkPrice.toLocaleString("uz")} </small>            
              
            <small className='ms-0 m-0 p-0 bg-success-subtle px-2 rounded mt-1'>{user.bulkPrice.toLocaleString("uz")}</small>
            
            </div>

             <svg
            onClick={() => {
                //props.clickDelete(item.id)
            }}
...
function SaleAdd(){
    return(
      ...
      <Form.Group className="mb-2" controlId="formBasicEmail">
        ...
        <Form.Control className="" type="email" placeholder="Сумма скидка" />
