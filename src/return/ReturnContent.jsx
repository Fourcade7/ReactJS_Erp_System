...
import { ReturnDetailScreen } from './ReturnDetail';
    ...
    >
      ...
      {activeTab==="sale_detail" && 
       <Tab eventKey="sale_detail" title="ℹ️ Детали возврата">
         <ReturnDetailScreen selectedSale={selectedSale} setActiveTab={setActiveTab} setSelectedSale={setSelectedSale}></ReturnDetailScreen>
      </Tab>
      }
